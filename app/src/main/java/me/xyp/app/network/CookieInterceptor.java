...
public class CookieInterceptor implements Interceptor {
    ...
    private static final Charset GB2312 = Charset.forName("UTF-8");
    ...
    public CookieInterceptor(Logger logger) {
        this.logger = logger;
    }
     ...
     */
    public CookieInterceptor setLevel(Level level) {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logHeaders) {
            ...
            if (!logBody || !hasRequestBody) {
                ...
                if (contentType != null) {
                    charset = contentType.charset(GB2312);
                }
